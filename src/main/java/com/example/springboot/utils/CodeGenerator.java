...
public class CodeGenerator {
    ...
    // 数据库名称
    private static final String DATASOURCE = "carmange";
    
    // 你自己的项目路径，一定要改成你自己的！！结尾必须是:  \\springboot\\
    private static final String basePath = System.getProperty("user.dir");

    // 数据库需要生成代码的表名
    private static final String tableName = "locus";
    // 生成页面的菜单名称
    private static final String modelName = "车辆轨迹管理";
